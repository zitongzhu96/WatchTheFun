...
async function mockAccountLocked() {
  ...
  await LoginButton.click();
  await driver.wait(webdriver.until.alertIsPresent());
  a51 = await driver.switchTo().alert();
  a51Text = await a51.getText();
  expect(a51Text).toEqual('Password incorrect, please try again!');
  await a51.dismiss();
  ...
  await LoginButton.click();
  await driver.wait(webdriver.until.alertIsPresent());
  a52 = await driver.switchTo().alert();
  a52Text = await a52.getText();
  expect(a52Text).toEqual('Password incorrect, please try again!');
  await a5.dismiss();
...
describe ('Login test', () => {
  it('should forward to the correct main page', (async () => {
    ...
    await driver.wait(webdriver.until.elementLocated(webdriver.By.id('grid-username')), 10000);
    const username = await driver.findElement(webdriver.By.id('grid-username')).getAttribute('innerHTML');
